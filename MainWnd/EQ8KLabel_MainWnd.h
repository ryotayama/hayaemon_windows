//----------------------------------------------------------------------------
// EQ8KLabel_MainWnd.h : イコライザ ( 8KHz ) 表示用ラベルの管理を行う
//----------------------------------------------------------------------------
#ifndef EQ8KLabel_MainWndH
#define EQ8KLabel_MainWndH
...
#endif
//----------------------------------------------------------------------------
// イコライザ ( 8KHz ) 表示用ラベルの管理を行うクラス
//----------------------------------------------------------------------------
class CEQ8KLabel_MainWnd : public CStatic
{
public: // 関数

	CEQ8KLabel_MainWnd(CApp & app, CMainWnd & mainWnd)
		: m_rApp(app), m_rMainWnd(mainWnd), m_rClickMenu(mainWnd),
		  m_edit(app, mainWnd, _T('-')) { }
	virtual ~CEQ8KLabel_MainWnd() { }

	virtual BOOL Create();
	virtual int GetHeight() const;
	virtual int GetTop() const;
	virtual void SetEQ8K(int nEQ8K);
