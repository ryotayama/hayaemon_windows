...
<context>
    ...
    <message>
        <location filename="MainWnd/MainWnd.cpp" line="482"/>
        <source>No Title</source>
        <translation>無題</translation>
    </message>
    <message>
        <location filename="MainWnd/MainWnd.cpp" line="485"/>
        <source>failed to create playlist.</source>
        <translation>プレイリスト用リストビューの作成に失敗しました。</translation>
    </message>
    <message>
        <location filename="MainWnd/MainWnd.cpp" line="5650"/>
        ...
        <translation type="unfinished">読込可能ファイル(*.wav *.cda *.mp* *.ogg *.wma *.aiff *.aif *.ape *.flac *.m4a *.m4b *.mp4 *.aac *.nsf *.avi *.wmv *.mkv *.flv *.ini *.m3u *.m3u8);;再生可能ファイル(*.wav *.cda *.mp* *.ogg *.wma *.aiff *.aif *.ape *.flac *.m4a *.m4b *.mp4 *.aac *.nsf *.avi *.wmv *.mkv *.flv);;WAVE ファイル(*.wav);;CDA ファイル(*.cda);;MP3 ファイル(*.mp3);;MP2 ファイル(*.mp2);;MP1 ファイル(*.mp1);;Ogg Vorbis ファイル(*.ogg);;AIFF ファイル(*.aiff *.aif);;APE ファイル(*.ape);;FLAC ファイル(*.flac);;AAC ファイル(*.m4a *.m4b *.mp4 *.aac);;NSF ファイル(*.nsf);;AVI ファイル(*.avi);;WMV ファイル(*.wmv);;MKV ファイル(*.mkv);;FLV ファイル(*.flv);;設定状態ファイル(*.ini);;プレイリストファイル(*.m3u *.m3u8);;すべてのファイル (*.*)</translation>
    </message>
    <message>
        <location filename="MainWnd/MainWnd.cpp" line="6289"/>
        <source>failed to create menu.</source>
        <translation>メニューの作成に失敗しました。</translation>
    </message>
    <message>
        <location filename="MainWnd/MainWnd.cpp" line="6346"/>
        <source>failed to init BASS.DLL.</source>
        <translation>BASS の初期化に失敗しました。</translation>
    </message>
    <message>
        <location filename="MainWnd/MainWnd.cpp" line="6606"/>
        <source>Show Speed Control(&amp;S)</source>
        <translation>再生速度コントロールの表示(&amp;V)</translation>
    </message>
    <message>
        <location filename="MainWnd/MainWnd.cpp" line="6615"/>
        <source>Show Frequency Control(&amp;S)</source>
        <translation>再生周波数コントロールの表示(&amp;V)</translation>
    </message>
    <message>
        <location filename="MainWnd/MainWnd.cpp" line="6624"/>
        <source>Show Pitch Control(&amp;S)</source>
        <translation>音程コントロールの表示(&amp;V)</translation>
    </message>
    <message>
        <location filename="MainWnd/MainWnd.cpp" line="6633"/>
        <source>Show Volume Control(&amp;S)</source>
        <translation>音量コントロールの表示(&amp;V)</translation>
    </message>
    <message>
        <location filename="MainWnd/MainWnd.cpp" line="6642"/>
...
<context>
    ...
    <message>
        <location filename="MainWnd/PlayListView_MainWnd.cpp" line="87"/>
        <source>No.</source>
        <translation>No.</translation>
    </message>
    <message>
        <location filename="MainWnd/PlayListView_MainWnd.cpp" line="88"/>
        <source>Title</source>
        <translation>タイトル</translation>
    </message>
    <message>
        <location filename="MainWnd/PlayListView_MainWnd.cpp" line="89"/>
        <source>Artist</source>
        <translation>アーティスト</translation>
    </message>
    <message>
        <location filename="MainWnd/PlayListView_MainWnd.cpp" line="90"/>
        <source>Year</source>
        <translation>年</translation>
    </message>
    <message>
        <location filename="MainWnd/PlayListView_MainWnd.cpp" line="91"/>
        <source>Length</source>
        <translation>長さ</translation>
    </message>
    <message>
        <location filename="MainWnd/PlayListView_MainWnd.cpp" line="92"/>
        <source>File Name</source>
        <translation>ファイル名</translation>
    </message>
    <message>
        <location filename="MainWnd/PlayListView_MainWnd.cpp" line="93"/>
        <source>Path</source>
